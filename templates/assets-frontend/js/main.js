...
if (!isInIframe()) {
        ...
        if ($('.courses-active').not('.slick-initialized').length > 0) {
            $('.courses-active').slick({
                ...
                autoplaySpeed: 5000,
                arrows: true,
                prevArrow: '<span class="prev"><i class="fa fa-caret-left" style="font-size: 70px;"></i></span>',
                nextArrow: '<span class="next"><i class="fa fa-caret-right" style="font-size: 70px;"></i></span>',
                speed: 1500,
                slidesToShow: 3,
                slidesToScroll: 1,
                responsive: [
        ...
        if ($('.courses-active-3').not('.slick-initialized').length > 0) {
        ...
        if ($('.testimonials-active').not('.slick-initialized').length > 0) {
        ...
        if ($('.testimonials-2-active').not('.slick-initialized').length > 0) {
        ...
        if ($('.course-learner-slide').not('.slick-initialized').length > 0) {
        ...
        if ($('.shop-active').not('.slick-initialized').length > 0) {
            $('.shop-active').slick({
                slidesToShow: 1,
                slidesToScroll: 1,
                arrows: false,
        ...
        if ($('.shop-thumb-active').not('.slick-initialized').length > 0) {
